...
const deployFn: DeployFunction = async (hre) => {
  ...
  if(chainId == 8453){ //base main-net
    tomojiSignAddr = '0x4256e7Cd9d3e45aC71B6fF151295C098b7423451'
    //uniswap v3
    swapRouter = {
    ...
    tomojiSignAddr = '0x70b00A1002E2b299213B981A96A5edD8453DAD60'
  ...
  await deployAndVerifyAndThen({
    ...
    args: [swapRouter, proxyTomojiAddress, tomojiSignAddr],
  })
}
